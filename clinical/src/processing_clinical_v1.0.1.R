...
################################################################################
if(FALSE){
  inClinical <- "/ClinBio/SP-ClinicalBioinformatics/shared/RP3500/RP3500-01/clinical/vendor-data/2022-08-12_RP3500-01 Patient Tracker.xlsx"
...
clinical_list$Genomic %>% select(`Patient ID`,`Enrollment Gene`,TMB,MSI,Reversion,`Enrollment Test Type`,`germline status`,`Type of loss`,`ATM IHC`)
