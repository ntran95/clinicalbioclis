...
p <- add_argument(p, arg = "--keyAvail",
                  help = "logical to indicate whether path to program key is should be read in, defaulted to FALSE if variable is not supplied")
...
genomicstats <- as.logical(argv$genomicstats)
...
# trial <- "RP3500-01-01"
# outdir <- "../../clinical/"
# tracker <- "../../RP3500/RP3500-01/clinical/20220228_RP6306-01 Patient Tracker.xlsx"
# markers <- T
# response <- T
# snipdx <- T
...
interactive <- FALSE
if(interactive){
  # tracker <- '/ClinBio/SP-ClinicalBioinformatics/shared/RP3500/RP3500-01/clinical/vendor-data/2022-12-12_RP-3500-03 ATTACC Patient Status Tracker_Working Copy.xlsx'
  tracker <- '/ClinBio/SP-ClinicalBioinformatics/shared/RP3500/RP3500-01/clinical/vendor-data/2022-12-12_RP3500-01 Patient Tracker.xlsx' 
  ...
  genomicstats <- T
  # inctdna <- "/ClinBio/SP-ClinicalBioinformatics/shared/RP3500/RP3500-03/ctDNA/processing/Combined/results/2022-12-11_RP3500-03_filtered_ctDNA_results/2022-12-11_RP3500-03_filtered_ctDNA_Summary.xlsx"
  inctdna <- "/ClinBio/SP-ClinicalBioinformatics/shared/RP3500/RP3500-01/ctDNA/processing/Combined/results/2022-12-09_RP3500-01_filtered_ctDNA_results/2022-12-09_RP3500-01_filtered_ctDNA_Summary.xlsx"
...
if(genomicstats){
  ...
  dfmVAFRBest <- ctdna_dfs$best_mvaf
  ...
  dfmVAFRBest <- dfmVAFRBest %>% 
    ...
    select(`Patient ID`,`Molecular.Response`,mVAFR) %>% 
    dplyr::rename(c(`Molecular Response` = Molecular.Response, `Best mVAFR` = mVAFR))
